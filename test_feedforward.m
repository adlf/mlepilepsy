function [se, sp, f, o_se, o_sp, o_f, threshold, name] = test_feedforward(layers, train_input, train_target, test_input, test_target,type,iterations)
